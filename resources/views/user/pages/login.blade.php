            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form action="/login" method="POST" class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ old('email') }}" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan email anda" >
                    </div>
                    <div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Belum memiliki akun? <a href="/register" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Daftar</a>
                    </p>
                </form>
            </div>
        </div>
