...
@section('wrapper')
    ...
    @endpush
    <section x-data="{ product:0 }" class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
                                    ...
                                    <td class="px-3 py-3 flex items-center justify-end">
                                        ...
                                        <div id="dropdown-{{ $product->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm" aria-labelledby="dropdown-button-{{ $product->id }}">
                                                ...
                                                <li>
                                                    <button x-on:click="selectedId = {{ $product->id }}" type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
